...
##model.k = 2; model.c = 0;
##model.G = @(x) 100;; et = [0 -1 -1 -1];
##Tex = -25*(xnode.*xnode)+65*xnode+10;
##T = elemFinitos(xnode, model, cb, et);
...
##model.rho = 1; model.cp = 1;
##model.k = 1; model.c = 0;
##model.G = @(x) 100*((x-3)^2); et = [0 -1 -1 -1];
...
##model.rho = 1; model.cp = 1;
##model.k = 2; model.c = 0;
##model.G = @(x) x^3; et = [2 2000 1e-5 0.1];
